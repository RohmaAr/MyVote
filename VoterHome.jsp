...
<body>
  <nav>
    ...
    <a href="#">Contact</a>
    <div class="right">
     <a href="#">Logged in as <%=session.getAttribute("name") %></a>
  </div>
  </nav>
  ...
  <button class="dropbtn">Apply for Participation</button>
  <div class="dropdown-content">
    <a href="applypart?option=p">in Provincial</a>
    <a href="applypart?option=n">in National</a>
    <a href="applypart?option=r">in regional</a>
  </div>
</div></div>
    <div class="menu-item"> <a href="Result.jsp">View Results </a></div>
